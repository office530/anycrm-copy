                            ...
                            {colors.map((c) => (
                                <button
                                    ...
                                    className={`group relative w-12 h-12 rounded-full flex items-center justify-center transition-all ${c.class} 
                                        ${branding.primaryColor === c.value ? 'ring-4 ring-offset-2 ring-slate-200 scale-110 shadow-lg' : 'opacity-80 hover:opacity-100 hover:scale-105'}`}
                                >
                                    {branding.primaryColor === c.value && <Check className="w-6 h-6 text-white" />}
                                </button>
                            ))}
                        </div>
                        <div className="p-4 bg-slate-50 rounded-lg border border-slate-200 mt-4 flex items-center gap-4">
                            <div className={`px-4 py-2 rounded-md text-white font-medium bg-${branding.primaryColor}-600 shadow-sm`}>
                                כפתור לדוגמה
                            </div>
                            <div className={`text-${branding.primaryColor}-600 font-bold`}>
                                טקסט מודגש לדוגמה
                            </div>
                        </div>
                    </div>
...
function PipelineSettings() {
    const { pipelineStages, setPipelineStages, updateStage } = useSettings();
