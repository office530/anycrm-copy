    ...
    <div className={`min-h-screen font-heebo flex transition-colors duration-300 relative overflow-hidden ${theme === 'dark' ? 'bg-[#0f172a] text-slate-100' : 'bg-slate-50 text-neutral-900'}`} dir="ltr">
      ...
      <aside className={`
        ...
        ${theme === 'dark' 
          ...
          : 'bg-white/40 backdrop-blur-2xl md:bg-gradient-to-br md:from-blue-100/40 md:via-white/60 md:to-pink-100/40 text-slate-600 border-white/20 shadow-xl shadow-indigo-100/10'}
                          ...
                          return (
                              ...
                              className={`
                                  ...
                                  : theme === 'dark'
                                    ...
                                    : 'text-slate-500 hover:bg-white/50 hover:text-indigo-600 transition-all'}
                              `}
                              >
