...
import {
  LayoutDashboard, Users, Briefcase, Menu, X, Search, Bell, Zap, BarChart3, LogOut, Settings as SettingsIcon, Sun, Moon, Database } from
'lucide-react';
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-8 border-b border-neutral-50">
              ...
              <div className="bg-red-700 rounded-lg p-2 shadow-md shadow-red-900/20">
                ...
                <p className="text-xs text-neutral-500 mt-2 font-medium tracking-wide opacity-80 dark:text-neutral-600">Old Leads Database</p>
            </div>
