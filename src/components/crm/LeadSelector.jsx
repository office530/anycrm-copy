    ...
    return (
        <div className="space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-200 mb-6">
            <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-bold text-slate-800 text-sm">Select Lead to Link (Required)</h3>
            </div>
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200">
                {isLoading ? (
                    ...
                    leads.map(lead => (
                        ...
                        >
                            <div>
                                ...
                                <div className="text-xs text-slate-500">{lead.phone_number} • {lead.city || 'No city'}</div>
                            </div>
                    ...
                    <div className="text-center text-xs text-slate-400 py-2">No results found</div>
                )}
            </div>
        </div>
    );
